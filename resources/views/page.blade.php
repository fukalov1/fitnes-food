...
@section('content')
    ...
    @foreach($page_blocks as $page_block)
        ...
        @if($page_block->type == '1')
            ...
            {{--</section>--}}
            <div class="container">
                <div class="about-page-item" style="background: url(/uploads/{{ $page_block->image }})no-repeat center;">
                    ...
                    <div>
                        <div class="about-page-form-item" v-if="success===false && error===''">
                            ...
                            <form id="send_order" class="" action="#" method="post">
                                ...
                                <input type="text" type="tel" v-mask="'+7(###)###-####'" v-model="phone" class="phone_numb" placeholder="Ваш номер телефона">
